...
<div className="signup-form my-5">
      <div className="screen">
        <div className="screen__content">
            <h2 className='float-left ml-5 mt-5'>Sign Up</h2>
          <form className="login signup ">
            <div className="login__field  col-md-6">
            ...
            <i class="mt-3 num-icon fa fa-phone" aria-hidden="true"></i>
                    </div>
            ...
            <div className='signup-number'>
              ...
              <input type="number" className="login__input" placeholder="Phone" />
            </div>
            </div>
            </div>
            <div className="login__field col-md-6">
            ...
            <i class="fa fa-key" aria-hidden="true"></i>
              <input type="password" className="login__input" placeholder="Choose Password" />
            </div>
      

            <p className='mt-5 mr-5 sugg'> <div className='sign-main-btn'>
            <a href="/book" class="com-btn-view signup-btn">Signup</a>
                 </div>
                 <span className='already-sugg' >Have an Account?
        ...
        <div className="screen__background">
          ...
          <span className="screen__background__shape screen__background__shape1 signup-shape"></span>
        </div>
      </div>
    </div>
                </div>
