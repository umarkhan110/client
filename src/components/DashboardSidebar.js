    ...
    <>
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <p class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                   ...
                   <li class="nav-item">
                        <Link to="/client-dashboard" class="nav-link align-middle px-0">
                            <BiUser /><span class="ms-1 d-none d-sm-inline">Your Orders</span>
                        </Link>
                    </li>
                    {/* <li class="nav-item">
                        <Link to="/client-dashboard/profile" class="nav-link align-middle px-0">
